              ...
              <div class="row">
                <div class="col-md-4">
                  <div>
                    ...
                    <input type="text" class="col-md-4" name="field_description[{ADMIN_EXTRAFIELDS_ROW_ID}]" id="extf_{ADMIN_EXTRAFIELDS_ROW_ID}_description" value="{PHP.row.field_description}">
                  ...
                  <div class="row">
                    <div class="col-md-2">
                      ...
                      <input type="text" class="col-md-2" name="field_name[{ADMIN_EXTRAFIELDS_ROW_ID}]" id="extf_{ADMIN_EXTRAFIELDS_ROW_ID}_name" value="{PHP.row.field_name}">
                      <div class="help-text below">{PHP.L.ExtfCodeInfo}</div>
                    </div>
                    <div class="col-md-2">
                      <label for="extf_{ADMIN_EXTRAFIELDS_ROW_ID}_type">{PHP.L.ExtfType}:</label>
                      <select name="field_type[{ADMIN_EXTRAFIELDS_ROW_ID}]" id="extf_{ADMIN_EXTRAFIELDS_ROW_ID}_type" class="col-md-2">
                  ...
                  <div>
                    ...
                    <input type="text" name="field_default[{ADMIN_EXTRAFIELDS_ROW_ID}]" id="extf_{ADMIN_EXTRAFIELDS_ROW_ID}_default" class="col-md-4" value="{PHP.row.field_default}">
                  </div>
                </div>
                <div class="span3">
                  ...
                  <select name="field_parse[{ADMIN_EXTRAFIELDS_ROW_ID}]" class="col-md-2">
  ...
  <div class="col-md-4">
    ...
    <form action="{ADMIN_EXTRAFIELDS_URL_FORM_ADD}" method="post">
      ...
      <div>
        ...
        <input type="text" class="col-md-4" name="field_description" id="extf_field_description" value="">
        <div class="help-text below">{PHP.L.ExtfTitleInfo}</div>
      </div>
      ...
      <div class="row">
        <div class="col-md-2">
          ...
          <input type="text" class="col-md-2" name="field_name" id="extf_field_name" value="">
          <div class="help-text below">{PHP.L.ExtfCodeInfo}</div>
        </div>
        <div class="col-md-2">
          <label for="extf_field_type">{PHP.L.ExtfType}:</label>
          <select name="field_type" id="extf_field_type" class="col-md-2">
            <optgroup label="{PHP.L.ExtfTypeText}">
      ...
      <div>
        ...
        <input type="text" name="field_default" id="extf_field_default" class="col-md-4">
      </div>
      ...
      <div id="extf_type_input" class="row">
        <div class="col-md-2">
          <label>{PHP.L.ExtfParser}:</label>
          <select name="field_parse" class="col-md-2">
            <!-- FOR {TYPE} IN {PHP.parse_type} -->
        ...
        <div class="col-md-2">
          ...
          <input type="text" name="regex" value="" class="col-md-2">
      ...
      <div id="extf_type_checklistbox" style="float:right;">
        ...
        <input type="text" name="separator" value="" class="col-md-1">
      </div>
      ...
      <div id="extf_type_rangeint">
        <div class="row">
          <div class="col-md-1">
            ...
            <input type="text" name="intmin" class="col-md-1">
          </div>
          <div class="col-md-1">
            <label>{PHP.L.ExtfMax}:</label>
            <input type="text" name="intmax" class="col-md-1">
          </div>
          <div class="col-md-2">
      ...
      <div id="extf_type_rangefloat">
        <div class="row">
          <div class="col-md-1">
            <label>{PHP.L.ExtfMin}:</label>
            <input type="text" name="floatmin" class="col-md-1">
          </div>
          <div class="col-md-1">
            <label>{PHP.L.ExtfMax}:</label>
            <input type="text" name="floatmax" class="col-md-1">
          </div>
          <div class="col-md-2">
      ...
      <div id="extf_type_datetime">
        <div class="row">
          <div class="col-md-1">
            ...
            <input type="text" name="datemin" class="col-md-1">
          </div>
          <div class="col-md-1">
            <label>{PHP.L.ExtfMaxYear}:</label>
            <input type="text" name="datemax" class="col-md-1">
          </div>
          <div class="col-md-2">
            <label>{PHP.L.ExtfFormat}:</label>
            <input type="text" name="dateformat" class="col-md-2" value="{PHP.Ldt.datetime_medium}">
          </div>
        </div>
      </div>
